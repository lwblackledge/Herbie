...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'phpbb3_oauth_tokens', 'phpbb3_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'phpbb3_users', $this, './', 'php');
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('db.greatlakesgarrison.com', 'glgdb', 'scarif_terrible_it_security', 'glgforum', '', false, false);
    ...
    {
        $this->services['derky.sortablescaptcha.captcha.sortables'] = $instance = new \derky\sortablescaptcha\captcha\sortables($this->get('dbal.conn'), $this->get('cache.driver'), $this->get('config'), $this->get('log'), $this->get('request'), $this->get('template'), $this->get('user'), 'phpbb3_sortables_questions', 'phpbb3_sortables_answers', 'phpbb3_sortables_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'phpbb3_ext', './', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'phpbb3_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'phpbb3_notification_types', 'phpbb3_notifications', 'phpbb3_user_notifications');
    }
    ...
    /**
     * Gets the 'phpbbmodders.banhammer.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbmodders\banhammer\event\banhammer_listener A phpbbmodders\banhammer\event\banhammer_listener instance.
     */
    protected function getPhpbbmodders_Banhammer_ListenerService()
    {
        return $this->services['phpbbmodders.banhammer.listener'] = new \phpbbmodders\banhammer\event\banhammer_listener($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('cache.driver'), './', 'php');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'derky.sortables.tables.questions' => 'phpbb3_sortables_questions',
            'derky.sortables.tables.answers' => 'phpbb3_sortables_answers',
            'derky.sortables.tables.confirm' => 'phpbb3_sortables_confirm',
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbb3_',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'dbal.driver.class' => 'phpbb\\db\\driver\\mysql',
            'dbal.dbhost' => 'db.greatlakesgarrison.com',
            'dbal.dbuser' => 'glgdb',
            'dbal.dbpasswd' => 'scarif_terrible_it_security',
            'dbal.dbname' => 'glgforum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
