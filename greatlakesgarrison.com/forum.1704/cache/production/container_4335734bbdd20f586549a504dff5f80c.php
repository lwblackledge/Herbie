...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002e533e1d000000001f6633c5(
...
class phpbbtemplatetwiglexer_000000002e533e1d000000001f6633c5 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58fc0617c36c5964278515 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58fc0617c36e0979519257 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58fc0617c3680892884180 = array(
    ...
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, 'set_environment', array('env' => $env), $this->initializer58fc0617c36e0979519257);

        return $this->valueHolder58fc0617c36c5964278515->set_environment($env);
    }
    ...
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer58fc0617c36e0979519257);

        return $this->valueHolder58fc0617c36c5964278515->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer58fc0617c36e0979519257);

        return $this->valueHolder58fc0617c36c5964278515->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer58fc0617c36e0979519257 = $initializer;
    }
    ...
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, '__get', array('name' => $name), $this->initializer58fc0617c36e0979519257);

        if (isset(self::$publicProperties58fc0617c3680892884180[$name])) {
            return $this->valueHolder58fc0617c36c5964278515->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58fc0617c36c5964278515;
    ...
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58fc0617c36e0979519257);
    ...
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, '__isset', array('name' => $name), $this->initializer58fc0617c36e0979519257);
    ...
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, '__unset', array('name' => $name), $this->initializer58fc0617c36e0979519257);
    ...
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, '__clone', array(), $this->initializer58fc0617c36e0979519257);

        $this->valueHolder58fc0617c36c5964278515 = clone $this->valueHolder58fc0617c36c5964278515;
    }

    public function __sleep()
    {
        $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, '__sleep', array(), $this->initializer58fc0617c36e0979519257);

        return array('valueHolder58fc0617c36c5964278515');
    }
    ...
    {
        return $this->initializer58fc0617c36e0979519257;
    }
    ...
    {
        return $this->initializer58fc0617c36e0979519257 && $this->initializer58fc0617c36e0979519257->__invoke($this->valueHolder58fc0617c36c5964278515, $this, 'initializeProxy', array(), $this->initializer58fc0617c36e0979519257);
    }
    ...
    {
        return null !== $this->valueHolder58fc0617c36c5964278515;
    }
    ...
    {
        return $this->valueHolder58fc0617c36c5964278515;
    }
