...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'phpbb3_oauth_tokens', 'phpbb3_oauth_states', 'phpbb3_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'phpbb3_users', $this, $this->get('dispatcher'), './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'phpbb3_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'phpbb3_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'phpbb3_forums', 'phpbb3_posts', 'phpbb3_topics', 'phpbb3_users');
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbb3_ext', './../', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'phpbb3_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbb3_migrations', './../', 'php', 'phpbb3_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './../', 'php', 'phpbb3_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbb3_modules', './../', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'phpbb3_notification_types', 'phpbb3_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb3_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'phpbb3_notification_types', 'phpbb3_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'phpbb3_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'phpbb3_profile_fields', 'phpbb3_profile_lang', 'phpbb3_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000027fbad1100000000633918a8(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'phpbb3_bbcodes', 'phpbb3_smilies', 'phpbb3_styles', 'phpbb3_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'phpbb3_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'phpbb3_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'phpbb3_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'phpbb3_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'phpbb3_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'phpbb3_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'phpbb3_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'phpbb3_users');
    }
...
class phpbbtemplatetwiglexer_0000000027fbad1100000000633918a8 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58fc0612e625e462376475 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58fc0612e6277290096968 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58fc0612e6216652787660 = array(
    ...
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, 'set_environment', array('env' => $env), $this->initializer58fc0612e6277290096968);

        return $this->valueHolder58fc0612e625e462376475->set_environment($env);
    }
    ...
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer58fc0612e6277290096968);

        return $this->valueHolder58fc0612e625e462376475->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer58fc0612e6277290096968);

        return $this->valueHolder58fc0612e625e462376475->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer58fc0612e6277290096968 = $initializer;
    }
    ...
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, '__get', array('name' => $name), $this->initializer58fc0612e6277290096968);

        if (isset(self::$publicProperties58fc0612e6216652787660[$name])) {
            return $this->valueHolder58fc0612e625e462376475->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58fc0612e625e462376475;
    ...
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58fc0612e6277290096968);
    ...
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, '__isset', array('name' => $name), $this->initializer58fc0612e6277290096968);
    ...
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, '__unset', array('name' => $name), $this->initializer58fc0612e6277290096968);
    ...
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, '__clone', array(), $this->initializer58fc0612e6277290096968);

        $this->valueHolder58fc0612e625e462376475 = clone $this->valueHolder58fc0612e625e462376475;
    }

    public function __sleep()
    {
        $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, '__sleep', array(), $this->initializer58fc0612e6277290096968);

        return array('valueHolder58fc0612e625e462376475');
    }
    ...
    {
        return $this->initializer58fc0612e6277290096968;
    }
    ...
    {
        return $this->initializer58fc0612e6277290096968 && $this->initializer58fc0612e6277290096968->__invoke($this->valueHolder58fc0612e625e462376475, $this, 'initializeProxy', array(), $this->initializer58fc0612e6277290096968);
    }
    ...
    {
        return null !== $this->valueHolder58fc0612e625e462376475;
    }
    ...
    {
        return $this->valueHolder58fc0612e625e462376475;
    }
