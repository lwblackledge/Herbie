...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000421d43ee000000002dbe0aa4(
...
class phpbbtemplatetwiglexer_00000000421d43ee000000002dbe0aa4 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58fce879de13d273533179 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58fce879de15b196874441 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58fce879de0e3875107928 = array(
    ...
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, 'set_environment', array('env' => $env), $this->initializer58fce879de15b196874441);

        return $this->valueHolder58fce879de13d273533179->set_environment($env);
    }
    ...
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer58fce879de15b196874441);

        return $this->valueHolder58fce879de13d273533179->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer58fce879de15b196874441);

        return $this->valueHolder58fce879de13d273533179->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer58fce879de15b196874441 = $initializer;
    }
    ...
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, '__get', array('name' => $name), $this->initializer58fce879de15b196874441);

        if (isset(self::$publicProperties58fce879de0e3875107928[$name])) {
            return $this->valueHolder58fce879de13d273533179->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58fce879de13d273533179;
    ...
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58fce879de15b196874441);
    ...
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, '__isset', array('name' => $name), $this->initializer58fce879de15b196874441);
    ...
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, '__unset', array('name' => $name), $this->initializer58fce879de15b196874441);
    ...
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, '__clone', array(), $this->initializer58fce879de15b196874441);

        $this->valueHolder58fce879de13d273533179 = clone $this->valueHolder58fce879de13d273533179;
    }

    public function __sleep()
    {
        $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, '__sleep', array(), $this->initializer58fce879de15b196874441);

        return array('valueHolder58fce879de13d273533179');
    }
    ...
    {
        return $this->initializer58fce879de15b196874441;
    }
    ...
    {
        return $this->initializer58fce879de15b196874441 && $this->initializer58fce879de15b196874441->__invoke($this->valueHolder58fce879de13d273533179, $this, 'initializeProxy', array(), $this->initializer58fce879de15b196874441);
    }
    ...
    {
        return null !== $this->valueHolder58fce879de13d273533179;
    }
    ...
    {
        return $this->valueHolder58fce879de13d273533179;
    }
